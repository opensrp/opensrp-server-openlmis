...
public class ValidSourceMetaData extends BaseMetaData {
    ...
    public ValidSourceMetaData() {}

    public ValidSourceMetaData(String id, String programUuid, String facilityTypeUuid, String facilityName, String openlmisUuid) {
        super(id);
